...
const sumBalance = balanceArray.reduce((prev, currentValue) => prev + currentValue);
console.log(sumBalance);

// Tính tổng tiền của những sinh viên lớn hơn 25 tuổi
const balanceUpper25 = upper25Student.map((student) => student.balance);
const sumBalanceUpper25 = balanceUpper25.reduce((prev, currentValue) => prev + currentValue);
